<?php
require_once '../../Model/Back_Office/inscription.php';
...
} else if ($imageFileType != ("JPG" || "jpg") && $imageFileType != ("png" || "PNG") && $imageFileType != ("jpeg" || 'JPEG') && $imageFileType != ("gif" || "GIF")) {
	echo "Seulement JPG, JPEG, PNG & GIF sont acceptées.";
	$uploadOk = 0;
} else if ($_FILES ["fichier"] ["size"] > 500000000000000) {
...
if ($uploadOk == 0) {
	...
	if (move_uploaded_file ( $_FILES ["fichier"] ["tmp_name"], $target_file )) {
		...
		inscrireClient ( $cin, $nom, $prenom, $adresse, $email, $sexe, $pseudo, $motdepasse, $image );
